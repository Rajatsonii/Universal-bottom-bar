...
public class ProfileFragment extends Fragment {
    ...
    private static final String ARGS_LAYOUT_FILE_URL = ProfileFragment.class.getName() + ".layoutFileName";

    String mPageName;
    private View rootView;


    public static ProfileFragment newInstance(String pageName) {
